...
import type { SQSAdapterInstantiationInterface } from "./definition/interface/sqs-adapter-instantiation.interface.mjs";
...
class SQSService
{
	...
	public constructor(parameters: SQSAdapterInstantiationInterface)
	{
