...
describe(
	"Helper / simplifyError",
	(): void =>
	{
		it(
			"should simplify an error",
			(): void =>
			{
		...
		it(
			"should provide a placeholder for an error without message",
			(): void =>
			{
				const EXPECTED_RESULT: NormalizedError = {
		...
		it(
			"should add the simplified cause to the causes",
			(): void =>
			{
				const EXPECTED_RESULT: NormalizedError = {
					message: "lorem ipsum",
		...
		it(
			"should add all the simplified errors of an AggregateError to the causes",
			(): void =>
			{
				const EXPECTED_RESULT: NormalizedError = {
					message: "lorem ipsum",
