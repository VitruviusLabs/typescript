...
describe(
	...
	(): void =>
	{
		...
		it(
			'should return "class Name" when given a class or PascalCase named constructible',
			(): void =>
			{
		...
		it(
			'should return "anonymous async generator" when given an anonymous async generator function or method',
			(): void =>
			{
		...
		it(
			'should return "async generator name" when given an anonymous async generator function or method',
			(): void =>
			{
		...
		it(
			'should return "anonymous async function" when given an anonymous function or method',
			(): void =>
			{
		...
		it(
			'should return "async function name" when given a function or method',
			(): void =>
			{
		...
		it(
			'should return "anonymous generator" when given an anonymous function',
			(): void =>
			{
		...
		it(
			'should return "generator name" when given an anonymous function',
			(): void =>
			{
				const DUMMY: Values.NamedClass = new Values.NamedClass();
		...
		it(
			'should return "anonymous object" when given a null-prototype object or a record',
			(): void =>
			{
