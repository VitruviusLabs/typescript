...
function assertUnion<T>(value: unknown, tests: ReadonlyArray<Test<T>>): asserts value is T;

function assertUnion(value: unknown, tests: ReadonlyArray<Test<unknown>>): asserts value is unknown
{
