...
function isUnion<T>(value: unknown, tests: ReadonlyArray<Test<T>>): value is T;

function isUnion(value: unknown, tests: ReadonlyArray<Test<unknown>>): value is unknown
{
	return tests.some(
