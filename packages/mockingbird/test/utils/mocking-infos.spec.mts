...
describe("MockingInfos", (): void => {
	describe("decodeInfos", (): void => {
		it("should properly decode valid infos", (): void => {
		...
		it("should throw when given invalid data", (): void => {
			const FAKE_INFOS: MockingInfos = {
				token: "token",
				moduleIdentifier: "module",
				dependencyIdentifiers: ["dependency"],
	...
	describe("encodeInfos", (): void => {
		it("should properly store mocks and encode infos", (): void => {
