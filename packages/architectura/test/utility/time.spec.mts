...
describe("Time", (): void => {
	describe("format", (): void => {
		it("should output the year in place of the 'Y' character when the format contains it.", (): void => {
		...
		it("should output the month in place of the 'm' character when the format contains it.", (): void => {
			const TIME: Time = new Time();
		...
		it("should output the day in place of the 'd' character when the format contains it.", (): void => {
			const TIME: Time = new Time();
		...
		it("should output the hours in place of the 'H' character when the format contains it.", (): void => {
			const TIME: Time = new Time();
		...
		it("should output the minutes in place of the 'i' character when the format contains it.", (): void => {
			const TIME: Time = new Time();
		...
		it("should output the seconds in place of the 's' character when the format contains it.", (): void => {
			const TIME: Time = new Time();
	...
	describe("getNumberOfDaysBetween", (): void => {
		it("should properly calculate the difference when the input date is in the future.", (): void => {
			const TIME: Time = new Time();
		...
		it("should properly calculate the difference when the input date is in the past.", (): void => {
			const TIME: Time = new Time();
