...
import { type DummyDelegateDataInterface, type DummyInstantiationInterface, DummyModel, DummyTransformFactory, getDummy } from "../../mock/_index.mjs";
import { BaseFactory } from "../../src/_index.mjs";

describe("AdvancedFactory", (): void => {
