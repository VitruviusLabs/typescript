...
/* eslint-disable @stylistic/ts/comma-spacing,id-denylist -- Compact */
...
/* eslint-enable @stylistic/ts/comma-spacing,id-denylist -- Compact */

function curry(callable: CallableType): CallableType
{
	// eslint-disable-next-line @typescript-eslint/no-magic-numbers -- Optimisation
